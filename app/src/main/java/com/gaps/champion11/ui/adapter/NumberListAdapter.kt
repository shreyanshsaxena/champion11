...
class NumberListAdapter(private val numberList: List<NumberDetail>, val context: Context?) : RecyclerView.Adapter<NumberListAdapter.ViewHolder>() {
        ...
        override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            if(numberList[position].isSelected){
                if (context != null) {
                    holder.numberTxt.background=(ResourcesCompat.getDrawable(context.resources,R.drawable.borderallred,null))
                }
                holder.numberTxt.setTextColor(Color.WHITE)
            }
            else{
                if (context != null) {
                    holder.numberTxt.background=(ResourcesCompat.getDrawable(context.resources,R.drawable.borderall,null))
                }
